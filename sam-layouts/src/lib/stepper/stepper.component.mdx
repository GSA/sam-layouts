...
import * as StepperComponentStories from './stepper.component.stories';

<Meta of={StepperComponentStories} />
...
<Canvas>
  <Story of={StepperComponentStories.Stepper} />
</Canvas>
...
<Canvas>
  <Story of={StepperComponentStories.StepperWithNavigation} />
</Canvas>
